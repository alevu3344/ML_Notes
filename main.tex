...
utils.save_fig("qda_example.pdf")
\end{pycode}
\caption{A QDA plot generated using the external utils module.}
\end{figure}
...
utils.save_fig("generative_comparison.pdf")
\end{pycode}
...
utils.save_fig("density_estimation.pdf")
\end{pycode}
...
utils.save_fig("knn_boundaries.pdf")
\end{pycode}
...
utils.save_fig("curse_dimensionality.pdf")
\end{pycode}
...
utils.save_fig("perceptron_update.pdf")
\end{pycode}
...
utils.save_fig("fld_projection.pdf")
\end{pycode}
...
utils.save_fig("ls_vs_logistic.pdf")
\end{pycode}
...
utils.save_fig("sigmoid_function.pdf")
\end{pycode}
...
utils.save_fig("bias_variance_tradeoff.pdf")
\end{pycode}
...
utils.save_fig("feature_map_plot.pdf")
\end{pycode}
...
utils.save_fig("decision_tree_plot.pdf")
\end{pycode}
